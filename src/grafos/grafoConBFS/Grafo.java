...
import grafos.busqueda.interfaces.IEstrategiaBusqueda;
import grafos.common.Arco;
import grafos.common.Nodo;
public class Grafo implements IGrafoSinPesos, IEstrategiaBusqueda {
	...
	private boolean buscarRutaBFS(List<INodo> nodosRuta, Nodo nodoOrigen, Nodo nodoDestino) {
